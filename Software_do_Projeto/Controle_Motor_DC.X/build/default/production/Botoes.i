...
{
    char aux;
    aux = PORTDbits.RD6 && !b0Anterior;
    b0Anterior = PORTDbits.RD6;
    return( aux );
}
char b0_bordaDescida( void )
{
...
{
    char aux;
    aux = (PORTDbits.RD6 && !b0Anterior) || (!PORTDbits.RD6 && b0Anterior);
    b0Anterior = PORTDbits.RD6;
    return( aux );
}
char b0( void )
...
{
    char aux;
    aux = PORTDbits.RD7 && !b1Anterior;
    b1Anterior = PORTDbits.RD7;
    return( aux );
}
char b1_bordaDescida( void )
{
...
{
    char aux;
    aux = (PORTDbits.RD7 && !b1Anterior) || (!PORTDbits.RD7 && b1Anterior);
    b1Anterior = PORTDbits.RD7;
    return( aux );
}
char b1( void )
